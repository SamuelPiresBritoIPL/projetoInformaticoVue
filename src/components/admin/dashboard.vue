    ...
    <div class="card text-center">
      <div v-if="hasValue" class="card-body">
        <div class="text-start">
          <small v-if="adminLogged" class="card-title"
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-4">
                <div
                  ...
                  v-if="course.totalpedidos === 0"
                  :class="[{ 'text-bg-success': course.totalpedidos === 0 }]"
                ...
                >
                  <router-link
                    ...
                    :to="{
                      ...
                      params: { courseID: course.id }, // <-- changed 'props' to 'params'
                    }"
    ...
    getCoursesAberturas() {
      this.$axios
        ...
        .then((response) => {
          ...
          //console.log(this.coursesWithAberturas);
