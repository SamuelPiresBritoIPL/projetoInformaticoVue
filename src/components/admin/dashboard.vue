  ...
  <div class="container-fluid">
    ...
    <div class="card text-center">
      <div v-if="hasValue" class="card-body">
        ...
        <div class="card w-100 mt-2" v-for="course in coursesWithAberturas" :key="course">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-3">
                <div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
                  ...
                  <div class="card-body">
                    <div class="text-start" v-if="this.aberturasAbertas[course.id] && this.aberturasAbertas[course.id].hasPedidos == 1">
              ...
              <div class="col-12 col-sm-3">
                <div class="card text-bg-secondary mb-3" style="max-width: 18rem;">
                  ...
                  <div class="card-body">
                    <div class="text-start" v-if="this.aberturasAbertas[course.id] && this.aberturasAbertas[course.id].hasInscricao == 1">
                      <div v-for="abertura in course.aberturas" :key="abertura.id">
            ...
            <div class=" card mb-3 mx-auto text-center" :class="[{ 'text-bg-success' : course.totalpedidos === 0 }, { 'text-bg-warning' : course.totalpedidos !== 0 }]" style="max-width: 15rem;">
