	...
	<div class="container-fluid">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<hr />
				<h5
					v-if="alunoRequested && infoAluno.length != 0"
				...
				<div
					...
					<div
						...
						<div v-if="this.ucsInscritas.length == 0">
							...
							<p class="mb-4">
								O estudante não esta inscrito em nenhuma unidade curricular
							</p>
						</div>
						<div v-else>
							<div
								v-for="curso in this.ucsInscritas"
								:key="curso">
								...
								<table class="table text-start">
									...
									<tbody>
										<tr
											class="tableRow"
											v-for="cadeira in curso.cadeiras"
											:key="cadeira">
											<td>
					...
					<div
						...
						<div v-if="this.ucsAprovadas.length == 0">
							<h6 class="card-title mb-4">Unidades curriculares</h6>
							<p class="mb-4">
								O estudante não foi aprovado em nenhuma unidade curricular até
								ao momento
							</p>
						</div>
						<div v-else>
							<div
								v-for="curso in this.ucsAprovadas"
								:key="curso">
								<h6>{{ curso.nome }}</h6>
								<table class="table text-start">
									<thead>
					...
					<div
						...
						<div v-if="this.pedidos.length == 0">
							<h6 class="card-title mb-4">
								Pedidos de confirmação de unidades curriculares
							</h6>
							<p class="mb-4">
								O estudante não tem nenhum pedido de confirmação de unidades
								curriculares
							</p>
						</div>
						<div v-else>
