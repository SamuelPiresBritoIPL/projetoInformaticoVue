<template>
	<div class="container-fluid">
		...
		<div v-if="gerirCursoNaAplicacao && hasValue">
			<div
				v-if="this.counterStore.courseWithUCs.nome"
				class="card text-center">
				<div class="card-header">
					Gestão do curso:
					{{
						"[" +
						this.counterStore.courseWithUCs.codigo +
						"] " +
						this.counterStore.courseWithUCs.nome
					}}
				</div>
				<div class="card-body">
					<div
							...
							<div
								...
								<div class="card-body">
									<label
										...
										class="form-label"
										>Definir vagas para todos os turnos de cada tipo em
										simultâneo</label
									>
									<div
										v-for="tipoTurno in this.counterStore.tipoTurnoCurso"
										:key="tipoTurno"
