<template>
	<div class="container-fluid">
		<div class="row mt-4">
			<div
				class="col-md-1"
				:class="{ 'col-md-3': adicionarCadeirasForm == false }"></div>
			<div
				class="col-md-5"
			...
			<div
				v-if="adicionarCadeirasForm == true"
				class="col-md-5">
				<div class="card">
					<div class="card-body">
						...
						<div
							...
							<div
								v-for="cadeira in cadeirasNaoAprovadas"
								:key="cadeira.id">
								<p>
									<input
						...
						<div v-if="showBtnAdicionarUCOutroCurso == true">
							<select
								...
								v-on:change="
									this.counterStore.getCourseWithUCs(selectedCourse)
								">
						...
						<div v-if="cadeirasOutrosCursos.length > 0">
							...
							<div
								v-for="cadeira in cadeirasOutrosCursos"
								:key="cadeira">
								<p>
									<input
						...
						<div class="form-floating my-3">
							<textarea
								...
								v-model="requestDescription"></textarea>
